...
const std::string OSProject = "ThinkOS";
const std::string Creator = "By TheBottiger";
const std::string CreatorWebsite = "github.com/BottigerTheCynic";
...
namespace Anki {
  namespace Vector {
    ...
    void FaceInfoScreenManager::Init(Anim::AnimContext* context, Anim::AnimationStreamer* animStreamer)
    {
      ...
      ADD_SCREEN_WITH_TEXT(ClearUserData, Main, {"RESET DATA?"});
      ADD_SCREEN_WITH_TEXT(ClearUserDataFail, Main, {"UNABLE TO RESET DATA"});
      ADD_SCREEN_WITH_TEXT(Rebooting, Rebooting, {"Goodbye..."});
      ...
      #endif
      ADD_MENU_ITEM(Main, IsXray() ? "CLEAR" : "RESET DATA", ClearUserData);
    ...
    void FaceInfoScreenManager::DrawMain()
    {
      ...
      { {"OS: ", NamedColors::WHITE}, {"Think", NamedColors::RED}, {"OS", NamedColors::WHITE} },
      {osVer},
      {ssid},
      #if FACTORY_TEST
      {"IP: " + ip},
